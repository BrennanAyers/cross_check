...
class SeasonTest < MiniTest::Test
  ...
  def setup
    ...
    @game_1 = mock("Game 1")
    @game_1.stubs(winners_id: 1, type: "R", team_stats: @game_1_team_stats)
    ...
    @game_2 = mock("Game 2")
    @game_2.stubs(winners_id: 1, type: "R", team_stats: @game_2_team_stats)
    ...
    @game_3 = mock("Game 3")
    @game_3.stubs(winners_id: 2, type: "R", team_stats: @game_3_team_stats)
    ...
    @game_4 = mock("Game 4")
    @game_4.stubs(winners_id: 2, type: "P", team_stats: @game_4_team_stats)
  ...
  def test_returns_regular_season_goals_against
    @game_1_find.stubs(goals: 2)
    @game_2_find.stubs(goals: 2)
    @game_3_find.stubs(goals: 6)
    @game_4_find.stubs(goals: 1)
